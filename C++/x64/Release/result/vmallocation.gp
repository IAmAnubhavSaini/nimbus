...
set output "vmallocation.eps"

set xlabel "Burst Size (Gbps)"
set ylabel "Ave. # of VM allocated"
...
plot    "count_total.plo" using ($1/1000):3 w lp ls 1  title "Burst Duration = 60 sec, 1% samp", \
	    "count_total.plo" using ($1/1000):5 w lp ls 2 title "Burst Duration = 10 sec, 1% samp", \
		"count_total.plo" using ($1/1000):7 w lp ls 3 title "Burst Duration = 60 sec, 10% samp ", \
		"count_total.plo" using ($1/1000):9 w lp ls 4 title "Burst Duration = 10 sec, 10% samp"
