...
data = [[] for ii in range(9)]   #60 sec 1%
data1 = [[] for ii in range(9)] # 10 sec 1%
data2 = [[] for ii in range(9)] # 10 sec 1% standby
data3 = [[] for ii in range(9)] # 60 sec 10%

data4 = [[] for ii in range(9)] # 10 sec 1% standby
data5 = [[] for ii in range(9)] # 60 sec 1% standby
...
def getresult(infile, key, flag):
	...
	#print data
	if (flag == 0):
		data[int(key/500)] = (acc, total_vm)
	elif (flag == 1):
		data3[int(key/500)] = (acc, total_vm)
	elif (flag == 2):
		data5[int(key/500)] = (acc, total_vm)
...
def getresult1(infile, key, flag = "NULL"):
	...
	#logresult(acc, total_vm)
	if flag == "sb":
		data4[int(key/500)] = (acc, total_vm)
	else:
		data1[int(key/500)] = (acc, total_vm)
	#if key not in data1:
