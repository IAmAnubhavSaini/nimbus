...
def getresult_4(files, key, flag):
	global data
	overall_acc = []
	overall_vm = []
	for infile in files:
	...
	if (flag == 0):
		data[getkey(key)] = (sum(overall_acc)/len(overall_acc), sum(overall_vm)/len(overall_vm))
	elif (flag == 1):
			data3[getkey(key)] = (sum(overall_acc)/len(overall_acc), sum(overall_vm)/len(overall_vm))
	elif (flag == 2):
		data5[getkey(key)] = (sum(overall_acc)/len(overall_acc), sum(overall_vm)/len(overall_vm))
	#print key, acc,total_vm



def getresult_9(files, key, flag):
	global data
	overall_acc = []
	overall_vm = []
	for infile in files:
...
getresult_9(["log_60_10_9_1.txt", "log_60_10_9_2.txt", "log_60_10_9_3.txt"], 9000, 1)
getresult_9(["log_60_10_6_1.txt", "log_60_10_6_2.txt", "log_60_10_6_3.txt"], 6000, 1)
getresult_4(["log_60_10_4_1.txt", "log_60_10_4_2.txt"], 4000, 1)
getresult_4(["log_60_10_2_1.txt"], 2000, 1)
getresult_4(["log_60_10_1_1.txt"], 1000,1)
getresult_4(["log_60_10_0_1.txt"], 0,1)
