...
plot    "count_total.plo" using ($1/1000):($2/100) w lp ls 1  title "Burst Duration = 10 sec, 1% samp", \
	    "count_total.plo" using ($1/1000):($4/100) w lp ls 2 title "Burst Duration = 60 sec, 1% samp", \
		"count_total.plo" using ($1/1000):($6/100) w lp ls 3 title "Burst Duration = 120 sec, 1% samp", \
		"count_total.plo" using ($1/1000):($8/100) w lp ls 4 title "Burst Duration = 10 sec, 1% sampl w/ one standby VM" 
